...
xmd treats LLMs as unix scripts. A script is a plain `.md` file you `chmod +x` and run: variables are arguments, stdout is the result, exit codes signal success or failure.
